...
Author: Denise Case, Alissa Beaderstadt
Date: 2026-06
...
OUTPUT_CHART: Final[Path] = OUTPUT_DIR / "sales_chart_beaderstadt.png"
...
def initialize_output() -> tuple[
    ...
    customer_type_totals: dict[str, float] = {
        "new": 0.0,
        "returning": 0.0,
    }
...
def process_message(  # noqa: D417
    ...
    *,
    ...
    Steps:
      ...
      - Update live chart
      - Store in database
      - Maintains real-time aggregations (customers, regions, customer types)
    ...
    if region_id:
        region_totals[region_id] = region_totals.get(region_id, 0.0) + total
...
def consume_messages(  # noqa: D417
    consumer: Any,
    *,
    region_lookup: dict[str, float],
    stats: RunningStats,
